...
public class DashboardRestController {
    ...
    public HashMap<String, Long> getDashboardStatistics(){
		 ...
		 * 
		 * //Line Chart List<MorisLine> morisLine = new ArrayList<>(); morisLine.add(new
		 * MorisLine("2011 Q1", 2666 )); morisLine.add(new MorisLine("2011 Q2", 2778 ));
		 * morisLine.add(new MorisLine("2011 Q3", 4912 )); morisLine.add(new
		 * MorisLine("2011 Q4", 3767 )); morisLine.add(new MorisLine("2012 Q1", 6810 ));
		 * morisLine.add(new MorisLine("2012 Q2", 5670 )); morisLine.add(new
		 * MorisLine("2012 Q3", 4820 )); morisLine.add(new MorisLine("2012 Q4", 15073
		 * )); morisLine.add(new MorisLine("2013 Q1", 10687 )); morisLine.add(new
		 * MorisLine("2013 Q2", 8432 ));
		 * 
